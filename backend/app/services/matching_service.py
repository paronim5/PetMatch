        ...
        if remaining_limit > 0:
            ...
            if user.preferences:
                ...
                if user.preferences.min_age:
                    ...
                    # make_interval(years, months, weeks, days, hours, mins, secs) - years is the first argument
                    min_birth_date = func.current_date() - func.make_interval(user.preferences.min_age)
                ...
                if user.preferences.max_age:
                    ...
                    max_birth_date = func.current_date() - func.make_interval(user.preferences.max_age + 1)
